(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".page-preview")) {
                let tumbsPrev = new swiper_core_Swiper(".background__slider", {
                    modules: [ Navigation, EffectFade, Controller, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    spaceBetween: 0,
                ...
                new swiper_core_Swiper(".preview-pages__slider", {
                    modules: [ Navigation, Pagination, EffectCoverflow, Controller, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
                    spaceBetween: 0,
        ...
        function updateTimer() {
            ...
            if (timerElement) {
                const formattedTime = `${formatNumber(hours)}H:${formatNumber(minutes)}M:${formatNumber(seconds)}S`;
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (accountElement && headerContainerElement) headerContainerElement.classList.add("header__container--has-account");
        }));
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
